    ...
    return (
        ...
        <div className='w-[1440px] h-sreen  '>
            ...
            <div className='flex justify-center pt-20 bg-[#D32242]'>
                <div className='h-[355px]   w-[483px] leading-3 py-12 m-20'>
                    <span className='block font-inter font-bold text-4xl text-white'>Look for <br />
                    
                        job to Apply? </span>
                        <Link to='/user-auth'> <button className='border-1 bg-black w-[155px] h-[45px] my-4 rounded-full text-white font-bold'>Apply for jobs</button></Link>
                </div>
